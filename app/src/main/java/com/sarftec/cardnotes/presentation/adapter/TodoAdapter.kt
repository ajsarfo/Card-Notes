...
import com.sarftec.cardnotes.databinding.LayoutTodoBinding
import com.sarftec.cardnotes.entity.TodoNotify
import com.sarftec.cardnotes.model.Todo
import com.sarftec.cardnotes.presentation.fragment.TodoFragment
            ...
            layoutBinding.todoMarkCard.setOnClickListener {
                ...
                fragmentContainer.todoFragment.lifecycleScope.launch {
                    if(todo.isCompleted) {
                        ...
                        if(todo.date > Calendar.getInstance().timeInMillis) {
