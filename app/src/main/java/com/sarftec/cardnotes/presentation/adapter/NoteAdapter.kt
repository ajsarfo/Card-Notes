...
import com.sarftec.cardnotes.databinding.LayoutNoteBinding
import com.sarftec.cardnotes.entity.MetaNote
import com.sarftec.cardnotes.presentation.fragment.NoteFragment
...
class NoteAdapter(
    ...
    fun deleteNotes() {
        noteFragmentCore.noteViewModel.deleteNotes(checkedNotes.toList())
        closeDelete()
    }
