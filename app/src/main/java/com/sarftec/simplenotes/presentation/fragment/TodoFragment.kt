...
import com.sarftec.simplenotes.databinding.FragmentTodosBinding
import com.sarftec.simplenotes.databinding.LayoutCreateTodoBinding
import com.sarftec.simplenotes.model.Todo
import com.sarftec.simplenotes.presentation.adapter.TodoAdapter
import com.sarftec.simplenotes.presentation.getExtendedDateString
import com.sarftec.simplenotes.presentation.getTimeString
...
import com.sarftec.simplenotes.presentation.viewmodel.SheetTodo
import com.sarftec.simplenotes.presentation.viewmodel.TodoViewModel
import com.sarftec.simplenotes.presentation.viewmodel.TodoViewModelNotification
...
class TodoFragment : Fragment() {
    ...
    private fun setupIntro() {
        layoutBinding.introCard.introTitle.text = getString(R.string.todo_intro_title)
        layoutBinding.introCard.introBody.text = getString(R.string.todo_intro_body)
        layoutBinding.introCard.childCard.setCardBackgroundColor(
            ContextCompat.getColor(requireContext(), R.color.color_toolbar)
        )
    }
    ...
    private fun launchTodoSheet() {
        ...
        binding.cancelAlert.setOnClickListener { _ ->
            todoViewModel.getTodo()?.let { it ->
                shouldAlert = false
                it.shouldAlert = shouldAlert
                todoViewModel.deleteNotify(it.id)
                setAlertText(binding, it)
